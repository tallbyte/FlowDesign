...
public class EnvironmentComment extends EnvironmentDiagramElement {
    ...
    protected ReferenceHandler referenceHandler = new ReferenceHandler(
        ...
        public String getText() {
            return EnvironmentComment.this.getText();
        }

        @Override
        public Diagram getDiagram() {
            return EnvironmentComment.this.getDiagram();
        }

        @Override
        public void setReference(Diagram reference) {
            EnvironmentComment.this.setInternalReference(reference);
        }

        @Override
        public Diagram getReference() {
            return EnvironmentComment.this.getReference();
        }

        @Override
        public void addPropertyChangeListener(PropertyChangeListener listener) {
            EnvironmentComment.this.addPropertyChangeListener(listener);
        }
    });

    protected Diagram reference;

    public EnvironmentComment() {
        setColor("#FFFFFF0F");
    }
